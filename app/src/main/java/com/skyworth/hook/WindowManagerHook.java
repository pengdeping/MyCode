    ...
    private static class ServiceFetcherHandler implements InvocationHandler {
        ...
        public Object invoke(Object o, Method method, Object[] objects) throws Throwable {
            if (method.getName().equals("getService")) {
                Class mServiceFetcher = Class.forName("android.app.SystemServiceRegistry$CachedServiceFetcher");
                Class mContextImpl = Class.forName("android.app.ContextImpl");
                @SuppressLint("BlockedPrivateApi") Method getService = mServiceFetcher.getDeclaredMethod("getService", mContextImpl);
